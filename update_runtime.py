...
try:
    print("Updating agent runtime to use the latest Docker image...")
    
    # Update the agent runtime with required parameters
    response = client.update_agent_runtime(
        agentRuntimeId='strands_agent-7kPP2NCKny',  # Use the runtime ID from the list
    ...
    print("The runtime will restart with the new image. This may take a few minutes.")
